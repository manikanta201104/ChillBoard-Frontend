...
export default function Footer() {
  ...
  return (
    <footer className="mt-12 border-t border-slate-200 bg-white">
      <div className="max-w-6xl mx-auto px-6 py-8 grid gap-6 md:grid-cols-3 text-slate-600">
        <div>
          <h3 className="text-slate-900 font-semibold">ChillBoard</h3>
        ...
        <div className="text-sm">
          ...
          <ul className="mt-2 space-y-2">
            ...
            <li><Link className="hover:text-slate-900" to="/email-policy">Email Policy</Link></li>
          </ul>
        </div>
        <div className="text-sm">
          <h4 className="text-slate-900 font-medium">Contact</h4>
          <ul className="mt-2 space-y-2">
            <li><a className="hover:text-slate-900" href="mailto:support@chillboard.in">support@chillboard.in</a></li>
            <li><a className="hover:text-slate-900" href="https://www.chillboard.in" target="_blank" rel="noreferrer">www.chillboard.in</a></li>
          </ul>
        </div>
      </div>
